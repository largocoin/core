...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Largo features */
        {"largo", "masternode", &masternode, true, true, false},
        {"largo", "listmasternodes", &listmasternodes, true, true, false},
        {"largo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"largo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"largo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"largo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"largo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"largo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"largo", "masternodedebug", &masternodedebug, true, true, false},
        {"largo", "startmasternode", &startmasternode, true, true, false},
        {"largo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"largo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"largo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"largo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"largo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"largo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"largo", "mnbudget", &mnbudget, true, true, false},
        {"largo", "preparebudget", &preparebudget, true, true, false},
        {"largo", "submitbudget", &submitbudget, true, true, false},
        {"largo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"largo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"largo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"largo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"largo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"largo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"largo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"largo", "checkbudgets", &checkbudgets, true, true, false},
        {"largo", "mnsync", &mnsync, true, true, false},
        {"largo", "spork", &spork, true, true, false},
        {"largo", "getpoolinfo", &getpoolinfo, true, true, false},
        {"largo", "getblacklist", &getblacklist, true, false, false},
        {"largo", "blockaddress", &blockaddress, true, false, false},
        ...
        {"zerocoin", "getzlrgseed", &getzlrgseed, false, false, true},
        {"zerocoin", "setzlrgseed", &setzlrgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzlrg", &searchdzlrg, false, false, true},
        {"zerocoin", "dzlrgstate", &dzlrgstate, false, false, true}
#endif // REMOVE_LATER
#endif // ENABLE_WALLET
};
...
{
    return "> largo-cli " + methodname + " " + args + "\n";
}
