...
extern UniValue setzlrgseed(const UniValue& params, bool fHelp);
extern UniValue getzlrgseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlrg(const UniValue& params, bool fHelp);
extern UniValue dzlrgstate(const UniValue& params, bool fHelp);
