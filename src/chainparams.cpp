...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Largo Coin! 25.02.2019";
	...
	txNew.vout[0].SetEmpty();
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1551178122;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4609752;
#if 0 // REMOVE_LATER When we will stop modifying the genesis block (and have to find new nonce to satisfy required difficulty.
	uint256 target;
	target.SetCompact( genesis.nBits );
	while(genesis.GetHash() > target) genesis.nNonce++;
	cout << "Genesis: " << genesis.ToString() << "\nHash: " << genesis.GetHash().GetHex() << endl;
#endif
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zlrg to be stakable
...
public:
    CTestNetParams()
    {
        ...
        // Testnet largo BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet largo BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet largo BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Largo: 1 day
        nTargetSpacing = 1 * 60;        // Largo: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1551189950;
