...
#ifndef LARGO_ZLRGTRACKER_H
#define LARGO_ZLRGTRACKER_H
...
public:
    CzLRGTracker(std::string strWalletFile);
    ~CzLRGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLRGWallet* zLRGWallet = NULL);
