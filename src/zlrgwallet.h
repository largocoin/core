...
#ifndef LARGO_ZLRGWALLET_H
#define LARGO_ZLRGWALLET_H
...
public:
    CzLRGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLRG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLRG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
