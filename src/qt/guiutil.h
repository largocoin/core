...
/** Utility functions used by the Largo Qt UI.
 */
namespace GUIUtil
{
...
// Render Largo addresses in monospace font
...
// Parse "largo:" URI into recipient object, return true on successful parsing
