...
/* Largo GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Largo"
#define QAPP_ORG_DOMAIN "largo.org"
#define QAPP_APP_NAME_DEFAULT "Largo-Qt"
#define QAPP_APP_NAME_TESTNET "Largo-Qt-testnet"
