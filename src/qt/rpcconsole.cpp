                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLRGPathCustom = GetArg("-zlrgbackuppath", "");
    ...
    if(!strzLRGPathCustom.empty()) {
        ui->wallet_customzlrgbackuppath->setText(QString::fromStdString(strzLRGPathCustom));
        ui->wallet_customzlrgbackuppath_label->setVisible(true);
        ui->wallet_customzlrgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLRGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Largo RPC console.") + "<br>" +
