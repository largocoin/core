...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Largo Core");
    ...
    QString copyrightTextLargo = QChar(0xA9) + QString(" 2019-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Largo Core developers"));
    ...
    if (titleTextWidth > 180) {
        // strange font rendering, Arial probably not found (or zooming enabled)
        fontFactor = 0.75;
    }
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextLargo);
