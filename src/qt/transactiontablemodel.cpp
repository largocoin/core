...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("LRG Stake");
    case TransactionRecord::StakeZLRG:
        return tr("zLRG Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted LRG to zLRG");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zLRG");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received LRG from zLRG");
    case TransactionRecord::ZerocoinSpend_Change_zLrg:
        return tr("Minted Change as zLRG from zLRG Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zLRG to LRG");
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZLRG:
    case TransactionRecord::MNReward:
        return QIcon(":/icons/transaction_mined");
    case TransactionRecord::RecvWithObfuscation:
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
    case TransactionRecord::RecvFromZerocoinSpend:
        return QIcon(":/icons/transaction_input");
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
    case TransactionRecord::ZerocoinSpend:
        return QIcon(":/icons/transaction_output");
    default:
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zLrg:
        return tr("Anonymous (zLRG Transaction)");
    case TransactionRecord::StakeZLRG:
        return tr("Anonymous (zLRG Stake)");
    case TransactionRecord::SendToSelf:
    default:
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZLRG || rec->type == TransactionRecord::MNReward) {
