...
#   c) node1 mines 32 blocks, so now node 0 has 60001lrg, node 1 has 4250lrg, node2 has none.
#   d) node0 sends 601 lrg to node2, in two transactions (301 lrg, then 300 lrg).
