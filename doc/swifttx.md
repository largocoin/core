...
This mechanism has been integrated into Bitcore-Node-Largo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Largo-Project/insight-api-largo#web-socket-api](https://github.com/Largo-Project/insight-api-largo#web-socket-api) 
* API: [https://github.com/Largo-Project/insight-api-largo#swifttx-transactions](https://github.com/Largo-Project/insight-api-largo#swifttx-transactions) 
...
By default, the Largo Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Largo Core daemon:
