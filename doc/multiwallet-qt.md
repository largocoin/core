...
In order to support loading of multiple wallets in largo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is largo.cpp.
...
Changes to largo.cpp
----------------------
largo.cpp is the entry point into largo-qt, and as such, will require some minor modifications to provide hooks for
