...
This means one can have an always-on largod instance running, and another local largod/largo-qt instance which connects to this node and receives blocks from it.
