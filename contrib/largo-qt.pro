...
RESOURCES += src/qt/largo.qrc src/qt/largo_locale.qrc

TRANSLATIONS += src/qt/locale/largo_bg.ts \
                src/qt/locale/largo_de.ts \
                src/qt/locale/largo_en.ts \
                src/qt/locale/largo_es.ts \
                src/qt/locale/largo_fi.ts \
                src/qt/locale/largo_fr.ts \
                src/qt/locale/largo_it.ts \
                src/qt/locale/largo_ja.ts \
                src/qt/locale/largo_pl.ts \
                src/qt/locale/largo_pt.ts \
                src/qt/locale/largo_ru.ts \
                src/qt/locale/largo_sk.ts \
                src/qt/locale/largo_sv.ts \
                src/qt/locale/largo_vi.ts \
                src/qt/locale/largo_zh_CN.ts \
                src/qt/locale/largo_zh_TW.ts
